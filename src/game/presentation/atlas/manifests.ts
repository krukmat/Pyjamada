...
import { HAUNTED_GHOST_ATLAS } from './HauntedGhostAtlas';
...
const WALLY_CLIPS: readonly ClipSpec[] = [
  { id: 'idle_sleepy', count: 2, durations: [500, 560], loop: 'loop' },
  { id: 'idle_normal', count: 2, durations: [420, 460], loop: 'loop' },
  { id: 'idle_rushed', count: 2, durations: [150, 150], loop: 'loop' },
  { id: 'idle_startled', count: 2, durations: [140, 160], loop: 'loop' },
  { id: 'walk_sleepy', count: 3, durations: [170, 200, 170], loop: 'loop' },
  { id: 'walk_normal', count: 3, durations: [105, 115, 105], loop: 'loop' },
  { id: 'walk_rushed', count: 3, durations: [70, 80, 70], loop: 'loop' },
  { id: 'walk_startled', count: 2, durations: [95, 105], loop: 'loop' },
  { id: 'wake', count: 3, durations: [90, 110, 180], loop: 'hold' },
  { id: 'alarm_recoil', count: 3, durations: [70, 90, 180], loop: 'hold' },
  { id: 'fumble', count: 3, durations: [75, 95, 180], loop: 'hold' },
  { id: 'equip_slippers', count: 3, durations: [80, 110, 150], loop: 'hold' },
  { id: 'wardrobe_change', count: 4, durations: [70, 80, 90, 110], loop: 'hold' },
  { id: 'collect_keys', count: 3, durations: [70, 90, 140], loop: 'hold' },
  { id: 'window_react', count: 3, durations: [80, 100, 140], loop: 'hold' },
  { id: 'rest', count: 3, durations: [100, 130, 120], loop: 'hold' },
  { id: 'success', count: 4, durations: [80, 100, 130, 250], loop: 'hold' },
  { id: 'fail_noise', count: 3, durations: [70, 90, 220], loop: 'hold' },
  { id: 'fail_exhausted', count: 3, durations: [120, 160, 260], loop: 'hold' },
  { id: 'fail_late', count: 3, durations: [70, 90, 220], loop: 'hold' },
];
...
export { HAUNTED_GHOST_ATLAS, HAUNTED_WALLY_ATLAS };
export const ALL_GAME_ATLASES = [WALLY_ATLAS, HAUNTED_WALLY_ATLAS, HAUNTED_GHOST_ATLAS, BEDROOM_OBJECTS_ATLAS, DOMESTIC_FX_ATLAS] as const;
