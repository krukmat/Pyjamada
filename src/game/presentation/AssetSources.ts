...
export const WALLY_ATLAS_SOURCE = require('../../../assets/game/wally/wally.png');
export const HAUNTED_WALLY_ATLAS_SOURCE = require('../../../assets/game/wally/haunted-wally.png');
